...
public class encoderTestingFinal extends LinearOpMode {
    ...
    public void drive(int targetFL, int targetBL, int targetFR, int targetBR, double speed) {
        ...
        leftPos1 += targetFL; //By adding the "+=", it makes it equivalent to leftPos1 = leftPos1 + leftTarget1, therefore it will allow adding values to the position based on what the target is.
        leftPos2 += targetBL; //This will therefore change where the motor needs to be by the specific inputted amount
        rightPos1 += targetFR;
        rightPos2 += targetBR;
